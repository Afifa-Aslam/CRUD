...
if(!function_exists('online_eshop_get_option_defaults_values')):
	...
	function online_eshop_get_option_defaults_values() {
		...
		$online_eshop_default_values = array(
			...
			'online_eshop_deisable_blogpost_sec' => 1,

			'online_eshop_disable_top_bar' => 1,
			'online_eshop_disable_top_social_icons' => 1,
			'online_eshop_disable_login_menu' => 1,
			'online_eshop_disable_mycart' => 1,
			'online_eshop_disable_search_form' => 1,
			...
			'online_eshop_slideshow_toptext_1' => 'SPRING SUMMER 2020',
			'online_eshop_slideshow_toptext_2' => 'MONOCHROME STYLE FOR WOMENS',
			'online_eshop_slideshow_toptext_3' => 'Summer, Winter Style',
			'online_eshop_slideshow_midtext_1' => 'cloths',
			'online_eshop_slideshow_midtext_2' => 'Jeans',
			'online_eshop_slideshow_midtext_3' => 'Jackets',
			'online_eshop_slideshow_bottext_1' => 'Collection 2019 - 20',
			'online_eshop_slideshow_bottext_2' => 'Collection 2019 - 20',
			'online_eshop_slideshow_bottext_3' => 'Collection 2019 - 20',
			...
			'online_eshop_feature_title_1' => 'FREE SHIPPING',
			'online_eshop_feature_title_2' => 'Cash On Delivery',
			'online_eshop_feature_title_3' => 'Support 24/7',
			'online_eshop_feature_title_4' => '30 Days Return',
			'online_eshop_feature_subtitle_1' => 'Best Shipping Service',
			'online_eshop_feature_subtitle_2' => 'Fast Delivery Method',
			'online_eshop_feature_subtitle_3' => '24 Hours a Day',
			'online_eshop_feature_subtitle_4' => 'Simply Return 30 Days.',
