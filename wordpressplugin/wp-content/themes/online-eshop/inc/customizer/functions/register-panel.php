...
add_action( 'customize_register', 'online_eshop_customize_register_featuredcontent' );
function online_eshop_customize_register_featuredcontent( $wp_customize ) {
	$wp_customize->add_panel( 'online_eshop_featuredcontent_panel', array(
		'priority' => 8,
		'capability' => 'edit_theme_options',
		'theme_supports' => '',
		'title' => __( 'Slider Options', 'online-eshop' ),
		'description' => '',
	) );
}
